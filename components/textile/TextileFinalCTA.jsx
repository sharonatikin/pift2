export default function TextileFinalCTA() {
  return (
    <section className="relative w-full py-24 sm:py-32 lg:py-40 bg-[#0A0A0A] flex flex-col items-center justify-center text-center overflow-hidden">
      <div className="absolute inset-0 z-0 bg-cover bg-center brightness-[0.22]" style={{ backgroundImage: `url('https://images.unsplash.com/photo-1544816155-12df9643f363?auto=format&fit=crop&w=1800&q=80')` }} />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-20 flex flex-col items-center">
        <h2 className="text-4xl sm:text-6xl lg:text-7xl font-normal tracking-tight text-white leading-[1.15] max-w-5xl mb-6">Create The Textiles <br />That <span className="italic font-medium text-[#FF4141]">Shape Industries.</span></h2>
        <p className="text-zinc-400 text-xs sm:text-sm font-light leading-relaxed tracking-wide max-w-xl mb-12">Transform your passion for fabrics, materials and surface design into a professional creative career.</p>

  ...
  return (
    <div className="min-h-screen bg-[#050102] text-white font-sans antialiased selection:bg-[#e6001a]">
      ...
      <section className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="absolute bottom-1/3 right-1/4 w-[500px] h-[350px] bg-[#e6001a]/5 blur-[120px] rounded-full pointer-events-none" />
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="grid grid-cols-1 md:grid-cols-12 gap-12 lg:gap-16 items-center mb-16 md:mb-20">
            ...
            <div className="md:col-span-7 space-y-6 text-left">
              <div className="space-y-3">
                <p className="text-[11px] font-bold tracking-[0.25em] text-zinc-500 uppercase">Program Overview</p>
                <h2 className="text-4xl sm:text-5xl lg:text-6xl font-light tracking-tight leading-[1.1] max-w-2xl">
                  <span className="font-serif block text-white font-medium">Turn Creative Ideas</span>
                  <span className="font-serif block text-white font-medium mt-1">Into <span className="italic text-[#e6001a] font-normal font-serif">Fashion</span></span>
                  <span className="font-serif block text-white font-medium mt-1">Businesses</span>
                </h2>
              </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5 max-w-7xl mx-auto">
            {overviewCards.map((card, idx) => (
              <div key={idx} className="bg-[#110d0e] border border-white/[0.03] hover:border-white/[0.07] rounded-2xl p-8 flex flex-col justify-start min-h-[220px] transition duration-300 ease-out group">
                ...
                <div className="space-y-3 flex-grow flex flex-col justify-start">
                  <h3 className="font-serif text-lg font-medium tracking-wide text-zinc-100 group-hover:text-white transition duration-200 leading-snug">{card.title}</h3>
                  <p className="text-zinc-400 text-xs sm:text-[13px] leading-relaxed font-light">{card.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 md:py-28 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[750px] h-[450px] bg-[#e6001a]/5 blur-[140px] rounded-full pointer-events-none" />
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-light tracking-tight leading-[1.15]">
              <span className="font-serif text-white font-medium">Craft.</span>{' '}
              <span className="italic font-serif text-[#e6001a] font-normal">Build.</span>
              <span className="font-serif block text-white font-medium mt-1">Lead.</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
            {highlightsCards.map((card, idx) => (
              <div key={idx} className="bg-[#110d0e]/90 border border-white/[0.03] hover:border-[#e6001a]/20 rounded-[24px] p-8 min-h-[300px] flex flex-col justify-between transition duration-300 ease-out group hover:bg-[#150f11]">
                <div className="space-y-6">
                  ...
                  <h3 className="font-serif text-xl md:text-2xl font-medium tracking-wide text-zinc-100 group-hover:text-white transition duration-200 leading-snug">{card.title}</h3>
                </div>
                <div className="space-y-6 mt-6">
                  <p className="text-zinc-400 text-xs sm:text-[13px] md:text-sm font-light leading-relaxed">{card.description}</p>
                  <div className="w-8 h-8 rounded-full border border-white/10 group-hover:border-[#e6001a] flex items-center justify-center text-zinc-500 group-hover:text-[#e6001a] transition duration-300">
      ...
      <section className="py-20 md:py-28 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="absolute top-0 left-1/4 w-[750px] h-[400px] bg-[#e6001a]/5 blur-[140px] rounded-full pointer-events-none" />
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-6xl">
            {semesters.map((sem, index) => (
              <div key={index} className="bg-[#110d0e]/90 border border-white/[0.03] rounded-[24px] p-8 md:p-10 transition duration-300 ease-out hover:border-white/[0.07] hover:bg-[#150f11] group">
                <div className="flex items-center gap-4 mb-6 md:mb-8">
                  <div className="w-9 h-9 rounded-full bg-[#e6001a]/10 border border-[#e6001a]/20 text-[#e6001a] font-sans text-sm font-semibold flex items-center justify-center transition duration-300 group-hover:bg-[#e6001a] group-hover:text-white group-hover:scale-105 flex-shrink-0">
                    {sem.number}
                  </div>
                  <h3 className="font-serif text-xl md:text-2xl font-medium tracking-wide text-zinc-100 group-hover:text-white transition duration-200">
                    {sem.title}
                  </h3>
                </div>
                <ul className="space-y-4">
                  {sem.courses.map((course, idx) => (
                    <li key={idx} className="flex items-start gap-3 text-zinc-400">
                      ...
                      <span className="text-sm md:text-base font-light tracking-wide group-hover:text-zinc-300 transition duration-200">{course}</span>
                    </li>
                  ))}
                </ul>
              </div>
      ...
      <section className="py-20 md:py-28 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-light tracking-tight leading-[1.15]">
              <span className="font-serif block text-white font-medium">Learn <span className="italic text-[#e6001a] font-normal font-serif">Beyond</span></span>
              <span className="font-serif block text-white font-medium mt-1">the Classroom</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5 max-w-6xl mx-auto">
            {classroomCards.map((card, idx) => (
              <div key={idx} className="bg-[#110d0e]/90 border border-white/[0.03] hover:border-[#e6001a]/20 rounded-[24px] p-8 flex flex-col justify-start min-h-[260px] transition duration-300 ease-out group hover:bg-[#150f11]">
                ...
                <div className="space-y-4">
                  <h3 className="font-serif text-lg md:text-xl font-medium tracking-wide text-zinc-100 group-hover:text-white transition duration-200 leading-snug">{card.title}</h3>
                  <p className="text-zinc-400 text-xs sm:text-[13px] font-light leading-relaxed">{card.description}</p>
                </div>
              </div>
            ))}
          </div>
      ...
      <section className="py-20 md:py-28 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-light tracking-tight leading-[1.15]">
              <span className="font-serif text-white font-medium">Career</span>
              <span className="italic font-serif block text-[#e6001a] font-normal mt-2">Pathways</span>
            </h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 max-w-6xl mx-auto">
            {pathways.map((item, idx) => (
              <div key={idx} className="bg-[#110d0e]/90 border border-white/[0.03] hover:border-[#e6001a]/20 rounded-[24px] p-8 min-h-[240px] flex flex-col items-center justify-center text-center transition duration-300 ease-out group hover:bg-[#150f11]">
                ...
                <h3 className="font-serif text-xl font-medium tracking-wide text-zinc-200 group-hover:text-white transition duration-200 leading-snug max-w-[180px]">{item.title}</h3>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-20 md:py-28 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="absolute top-1/4 right-0 w-[600px] h-[400px] bg-[#e6001a]/5 blur-[130px] rounded-full pointer-events-none" />
        <div className="max-w-7xl mx-auto relative z-10">
            ...
            <div className="lg:col-span-7 space-y-8 text-left lg:pl-4">
              <div className="space-y-4 max-w-2xl">
                <h2 className="text-4xl sm:text-5xl lg:text-6xl font-light tracking-tight leading-[1.1]">
                  <span className="font-serif block text-white font-medium">Build <span className="italic text-[#e6001a] font-normal font-serif">Networks.</span></span>
                  <span className="font-serif block text-white font-medium mt-1">Create Opportunities.</span>
                </h2>
              ...
              <div className="grid grid-cols-2 gap-4 max-w-xl">
                {stats.map((stat, idx) => (
                  <div key={idx} className="bg-[#110d0e]/90 border border-white/[0.03] rounded-2xl p-6 sm:p-8 flex flex-col justify-center min-h-[130px] transition duration-300 ease-out hover:border-white/[0.07] hover:bg-[#150f11] group">
      ...
      <section className="py-20 md:py-28 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        <div className="absolute top-1/3 left-0 w-[600px] h-[350px] bg-[#e6001a]/5 blur-[130px] rounded-full pointer-events-none" />
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="space-y-4 mb-20 md:mb-28 text-left">
            <p className="text-[10px] font-bold tracking-[0.3em] text-zinc-500 uppercase">Admissions</p>
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-light tracking-tight leading-[1.1]">
              <span className="font-serif block text-white font-medium">Start Your</span>
              <span className="italic font-serif block text-[#e6001a] font-normal mt-2">Journey</span>
            </h2>
          </div>
          <div className="relative max-w-6xl mx-auto">
            <div className="hidden lg:block absolute top-[56px] left-[6%] right-[6%] h-[1px] bg-[#e6001a]/60 pointer-events-none z-0" />
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-x-5 gap-y-16 lg:gap-y-0 relative z-10">
              {admissionSteps.map((step, idx) => (
                <div key={idx} className="relative group flex flex-col pt-7">
                  ...
                  <div className="bg-[#110d0e]/90 border-t border-white/5 border-x border-b border-white/[0.02] group-hover:border-white/[0.06] rounded-2xl p-6 lg:p-8 pt-10 lg:pt-12 min-h-[170px] flex flex-col justify-start transition duration-300 ease-out group-hover:bg-[#150f11]">
                    <h3 className="font-serif text-lg md:text-xl font-medium tracking-wide text-zinc-100 group-hover:text-white transition duration-200 leading-snug mb-3">{step.title}</h3>
                    <p className="text-zinc-400 text-xs sm:text-[13px] font-light leading-relaxed">{step.description}</p>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section className="py-20 md:py-28 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          <div className="text-center max-w-3xl mx-auto mb-16 md:mb-24">
            <h2 className="text-4xl sm:text-5xl lg:text-6xl font-light tracking-tight leading-[1.15]">
              <span className="font-serif text-white font-medium">Student</span>
              <span className="italic font-serif block text-[#e6001a] font-normal mt-2">Success Stories</span>
            </h2>
          </div>
            ...
            {testimonials.map((item, idx) => (
              <div key={idx} className="bg-[#110d0e]/90 border border-white/[0.03] hover:border-[#e6001a]/20 rounded-[24px] p-8 md:p-10 flex flex-col justify-between min-h-[380px] transition duration-300 ease-out group hover:bg-[#150f11]">
                ...
                <div className="flex-grow flex items-start">
                  <p className="text-zinc-400 text-sm sm:text-base font-light leading-relaxed tracking-wide italic">{item.quote}</p>
                </div>
                <div className="mt-8 space-y-1">
                  <h3 className="font-serif text-lg md:text-xl font-medium tracking-wide text-zinc-100 group-hover:text-white transition duration-200">{item.name}</h3>
                  <p className="text-zinc-500 text-xs md:text-sm font-light tracking-wide">{item.role}</p>
                </div>
              </div>
            ))}
          </div>
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          <div className="space-y-4 max-w-3xl mx-auto">
            {faqs.map((faq, idx) => {
              ...
              return (
                <div key={idx} className="bg-[#110d0e]/90 border border-white/[0.03] hover:border-white/[0.07] rounded-[20px] overflow-hidden transition-all duration-300 ease-out">
                  <button onClick={() => toggleFAQ(idx)} className="w-full px-6 md:px-8 py-5 md:py-6 flex items-center justify-between text-left group focus:outline-none">
                    ...
                    <div className="w-8 h-8 rounded-full bg-white/[0.01] border border-white/5 flex items-center justify-center text-[#e6001a]/70 group-hover:text-[#e6001a] group-hover:border-[#e6001a]/10 transition-all duration-300 flex-shrink-0 ml-4">
      ...
      <section className="bg-[#050102] text-white font-sans antialiased py-24 md:py-32 lg:py-40 px-4 sm:px-6 lg:px-8 relative overflow-hidden flex items-center justify-center min-h-[500px]">
        ...
        <div className="max-w-4xl mx-auto text-center space-y-8 relative z-10">
          <div className="space-y-4">
            <h2 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-light tracking-tight leading-[1.15]">
              <span className="font-serif text-white font-medium">Your</span>{' '}
              <span className="italic font-serif text-[#e6001a] font-normal">Fashion</span>
              <span className="font-serif block text-white font-medium mt-1">Business</span>
              <span className="font-serif block text-white font-medium mt-1">Starts Here.</span>
            </h2>
          </div>
          <p className="text-zinc-400 text-sm sm:text-base md:text-lg font-light leading-relaxed max-w-xl mx-auto tracking-wide">
